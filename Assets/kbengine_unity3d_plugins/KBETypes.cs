...
namespace KBEngine
{
	...
	public struct ITEM_COUNT
	{
		...
		ITEM_COUNT(UInt32 value)
		{
			this.value = value;
		}

		public static implicit operator UInt32(ITEM_COUNT value)
		{
			return value.value;
		}

		public static implicit operator ITEM_COUNT(UInt32 value)
		{
			UInt32 tvalue = (UInt32)value;
			return new ITEM_COUNT(tvalue);
		}
	...
	public class ITEM_INFO
	{
		...
		public Int32 itemIndex = 0;

	}

	public class ITEM_INFO_LIST
	{
		public List<ITEM_INFO> values = new List<ITEM_INFO>();
